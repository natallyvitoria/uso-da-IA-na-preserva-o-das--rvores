...
const perguntas = [
    {
        enunciado: "Antonio sempre foi curioso sobre novas tecnologias. Um dia, logo após a escola, ele descobriu um chat inovador que respondia todas as dúvidas com precisão e gerava imagens e áudios hiper-realistas. Imediatamente, ele teve uma reação:",
        alternativas: [
            {
    ...
    {
        enunciado: "Com o entusiasmo de Antonio, sua professora de tecnologia decidiu organizar uma série de aulas sobre IA. No final de uma dessas aulas, ela pediu aos alunos que escrevessem um trabalho sobre o uso da IA na preservação das árvores. Antonio ponderou suas opções e tomou uma decisão:",
        alternativas: [
            {
    ...
    {
        enunciado: "Após entregar seu trabalho, Antonio participou de uma discussão sobre o impacto da IA no futuro do trabalho. Durante a discussão, ele apresentou sua visão:",
        alternativas: [
            {
    ...
    {
        enunciado: "No final da discussão, a tarefa era criar uma imagem no computador que representasse suas opiniões sobre o uso da IA na preservação das árvores. Antonio escolheu:",
        alternativas: [
            {
